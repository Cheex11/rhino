...
storeLocator.Panel.prototype.init_=function(){var a=this;console.log(a);this.itemCache_={};this.settings_.view&&this.set("view",this.settings_.view);this.filter_=$('\x3cform class\x3d"storelocator-filter"/\x3e');this.el_.append(this.filter_);this.settings_.locationSearch&&(this.locationSearch_=$('\x3cdiv class\x3d"location-search"\x3e\x3ch4\x3e'+this.settings_.locationSearchLabel+"\x3c/h4\x3e\x3cinput\x3e\x3c/div\x3e"),$("#top-banner").append(this.locationSearch_),"undefined"!=typeof google.maps.places?this.initAutocomplete_():
...
storeLocator.View.prototype.geolocate_=function(){var a=this;window.navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(b){b=new google.maps.LatLng(b.coords.latitude,b.coords.longitude);console.log(b);a.getMap().setCenter(b);a.getMap().setZoom(6);google.maps.event.trigger(a,"load")},void 0,{maximumAge:6E4,timeout:1E4})};
