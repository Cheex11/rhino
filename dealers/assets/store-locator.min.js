...
var storeLocator = function() {};
    ...
    storeLocator.GMEDataFeed.prototype.getStores = function(a, b, c) {
    	...
    	console.log('storeLocator.GMEDataFeed.prototype.getStores was called.')
...
storeLocator.Panel.prototype.init_ = function() {
    ...
    this.settings_.locationSearch && (this.locationSearch_ = $('\x3cdiv class\x3d"location-search"\x3e\x3ch4\x3e' + this.settings_.locationSearchLabel + "\x3c/h4\x3e\x3cinput\x3e\x3c/div\x3e"), $("#top-banner").append(this.locationSearch_), "undefined" != typeof google.maps.places ? this.initAutocomplete_() :
...
storeLocator.StaticDataFeed.prototype.getStores = function(bounds, features, callback) {
	console.log('store locator getstores called.')
...
storeLocator.StaticDataFeed.prototype.sortByDistance_ = function(a, b) {
    ...
    for (i = 0; i < b.length; i++) {
	    ...
	    // console.log(b[i]);
	    // b[i].features_.add(this.FEATURES_.getById('Visible-' + 'YES'))
